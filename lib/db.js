...
// Upload a single document photo (insurance, registration, or inspection
// sticker) to Firebase Storage and return its download URL.
...
// Save the three document URLs on the driver's profile and flip status to
// "pending_review" so corporate/admin can approve or reject.
...
// Used by the admin dashboard to approve or reject a driver's submitted
// documents. Approving clears them to go online; rejecting sends them back
// to resubmit, with an optional reason shown to the driver.
